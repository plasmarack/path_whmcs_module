...
require dirname(__DIR__, 5) . '/init.php';

$currentUser = new \WHMCS\Authentication\CurrentUser;
$client = $currentUser->client();

$path_username = Capsule::table('tbladdonmodules')->where('module', 'pathfirewall')->where('setting', 'API_USERNAME')->first()->value;
$path_password = Capsule::table('tbladdonmodules')->where('module', 'pathfirewall')->where('setting', 'API_PASSWORD')->first()->value;
$path_url = Capsule::table('tbladdonmodules')->where('module', 'pathfirewall')->where('setting', 'API_BASE')->first()->value;

require '../PathClass.php';
$path = new PathClass($path_username, $path_password, $path_url);
